...
// 웹뷰 멀티 터치 가능하게 (줌기능)
        ...
        webView.loadUrl("http://203.252.240.63:80/insect");
    ...
    class  AndroidBridge{
        ...
        public void weather() {
            ...
            intent.putExtra("button" , "weather");
            startActivity(intent);
        }
        // 병해충 검색
        @JavascriptInterface
        public void insect() {
            Intent intent = new Intent(getApplicationContext(), insect.class);
            intent.putExtra("button" , "insect");
            startActivity(intent);
        }
    }
}
